        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">AI-Powered Repository Analysis</p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`text-center mb-8 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <p className="text-gray-300 text-lg">
              Enter a GitHub repository URL and ask any question about its code, commits, or structure
            </p>
          </div>

          {/* Query Form */}
          <div className={`space-y-6 mb-8 transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          {response && (
            <div className="p-6 rounded-xl bg-gradient-to-r from-gray-900/50 to-gray-800/50 border border-gray-700/50 backdrop-blur-sm animate-fadeIn">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-green-400">Genie's Response</h3>
      ...
      {loading && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-gray-900 p-8 rounded-2xl border border-gray-700 text-center max-w-md mx-4">
            ...
            <h3 className="text-xl font-semibold mb-2">🧞‍♂️ Genie is thinking...</h3>
            <p className="text-gray-400">Analyzing repository and preparing your answer</p>
          </div>
        </div>
      )}
    </div>
